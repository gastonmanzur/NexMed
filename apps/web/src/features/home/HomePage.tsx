...
const quickFeatures = [
  { icon: '📅', title: 'Agenda profesional', text: 'Turnos por profesional, sede y servicio con una vista clara de toda la operación.', image: 'https://www.meta.ai/create/1114411481760145' },
