...
const fallbackContent: any = { hero: { eyebrow: 'NexMed | Agenda, turnos y pacientes para centros de salud y estética', title: 'Organizá turnos, automatizá recordatorios y ordená la agenda de tu centro en un solo sistema.', subtitle: 'NexMed te ayuda a reducir trabajo manual en recepción y a sostener una atención más clara para pacientes y equipo.', media: { url: HERO_FALLBACK_IMAGE }, ctas: { demo: { label: 'Ver demo', href: '/app/demo', visible: true }, whatsapp: { label: 'Hablar por WhatsApp', visible: true }, login: { label: 'Ingresar', href: '/login', visible: true }, register: { label: 'Registrarse', href: '/register', visible: true } }, whatsapp: { number: '541122626516', message: 'Hola, quiero una demo de NexMed' } }, features: [] };
        ...
        <section id="inicio" className="nx-landing__hero">
          ...
          <div className="nx-landing__hero-content">
            ...
            <div className="nx-landing__cta-grid">
              ...
              <a className="nx-btn" href="/app/demo">Ver demo</a>

              <a className="nx-btn" href="/demo">Ver demo</a>
       ...
       <section className="nx-landing__section nx-landing__section--steps">
        ...
        <section id="contacto" className="nx-landing__section nx-landing__section--cta">
          ...
          <div className="nx-landing__cta-grid">
            ...
            <Link className="nx-btn" to="/app/demo">Ver demo</Link>
