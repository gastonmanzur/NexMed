...
const organizationSchema = new mongoose.Schema(
  {
    ...
    latitude: { type: Number, required: false, min: -90, max: 90, default: null },
    longitude: { type: Number, required: false, min: -180, max: 180, default: null },
    locationLabel: { type: String, required: false, trim: true },
    locationPublic: { type: Boolean, default: false },
