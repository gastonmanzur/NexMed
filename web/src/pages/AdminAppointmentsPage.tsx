    ...
    <>
      ...
      <Card className="ui-form-row">
        <div className="ui-grid-4">
          ...
          <div className="ui-input-with-icon"><label className="ui-label" htmlFor="status">Estado</label><span className="ui-input-leading-icon"><Icon name="filter" size={16} /></span><Select id="status" value={status} onChange={(e) => setStatus(e.target.value)}><option value="all">Todos</option><option value="booked">Reservado</option><option value="confirmed">Confirmado</option><option value="canceled">Cancelado</option></Select></div>
        </div>
